package com.yunrun.znbptapi.util;
 ...
 * 注意：该类不处理金钱货币，金钱货币的处理运算请使用com.chcdudu.common.util.Money类。
 * @author sharewind     
 * @version 1.0  
...
public class ArithUtil {
    ...
    public static final String STR_DB_HUNDRED = "100.0";
     ...
     * @return 百分比除法后的结果
     */
    public static String percentMul(String v){
    	return round(mul(v, STR_DB_HUNDRED), 2, BigDecimal.ROUND_DOWN);
    }
