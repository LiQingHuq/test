...
function deleteBlog(){
	...
	if(selectedRows.length==0){
	 ...
	 for(var i=0;i<selectedRows.length;i++){
		 strIds.push(selectedRows[i].blog_id);
	 }
	 var ids=strIds.join(",");
	 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${path}/BlogAction/blog!delete.action",{
					ids:ids
					},
					function(result){//返回result的json对象
					if(result.success){
...
<table id="dg" title="博客管理" class="easyui-datagrid"
   ...
   url="${path}/BlogAction/blog!findAll.action" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="blog_id" width="20" align="center">博客编号</th>
   		<th field="blog_title" width="200" align="center" >标题</th>
   		<th field="blog_time" width="50" align="center">发布日期</th>
   		<th field="type_name" width="50" align="center">博客类别</th>
   	</tr>
   </thead>
</div>
 </table> 
