...
<div class="data_list">
    ...
    <div>
                           <p>
                            <a href="${path}/BlogAction/blog!findAll1.action?page=1">&lt;&lt; 首页 </a>
                               <c:if test="${pageSize.pc>1}">
                            <a href="${path}/BlogAction/blog!findAll1.action?page=${pageSize.pc-1}">&lt; 上一页 </a>
                              </c:if>
                              
                            <strong>第${pageSize.pc}页/共${pageSize.pageTotal}页</strong>
                             
                             <c:if test="${pageSize.pc<pageSize.pageTotal}">
                            <a href="${path}/BlogAction/blog!findAll1.action?page=${pageSize.pc+1}">下一页 &gt;</a>
                            </c:if>
                       
                            <a href="${path}/BlogAction/blog!findAll1.action?page=${pageSize.pageTotal}">末页 &gt;&gt;</a>  
